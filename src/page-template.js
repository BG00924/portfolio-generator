...
const generateProjects = projectsArr => {
    // gets refractored below
    // get array of just featured 
    ...
    //     }
    // })
    // // get arre of all non-featured
    // const nonFeaturedProjects = projectArr.filter(project => {
    //     if (!project.feature) {
    //         return true;
    //     } else {
    //         return false:
    ...
    //             <!-- leaving empty as dynamically insert project html here-->
...
module.exports = templateData => {
    ...
    // will pull out projects and about and store the rest
    // of the data not destructured yet in new object header
